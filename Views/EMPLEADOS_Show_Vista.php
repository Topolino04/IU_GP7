...
?>
	<a href='./EMPLEADOS_Controller.php?accion=Consultar'><?php echo $strings['Consultar']?></a>
	<--------->
	<a href='./EMPLEADOS_Controller.php?accion=Insertar'><?php echo $strings['Insertar']?></a>
	<--------->
