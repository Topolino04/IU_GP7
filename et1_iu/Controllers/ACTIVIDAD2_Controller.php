...
include '../Models/ACTIVIDAD2_Model.php';
include '../Locates/Strings_Castellano.php';
include '../Functions/LibraryFunctions.php';
include '../Views/MENSAJE_Vista.php';
include '../Views/ACTIVIDAD2_ADD_HORAS_Vista.php';
include '../Views/ACTIVIDAD2_ADD_Vista.php';
include '../Views/ACTIVIDAD2_DELETE_Vista.php';
include '../Views/ACTIVIDAD2_EDIT_Vista.php';
include '../Views/ACTIVIDAD2_OCULTAS_Vista.php';
include '../Views/ACTIVIDAD2_SHOW_ALL_Vista.php';
include '../Views/ACTIVIDAD2_SHOW_Vista.php';
...
//Inserción de actividades
			if (!isset($_REQUEST['ACTIVIDAD_NOMBRE'])) {
					...
					if (!tienePermisos('Actividad_Add')) {
						new Mensaje('No tienes los permisos necesarios', 'ACTIVIDAD2_Controller.php');
					} else {
						new Actividad_Add();
					}
				...
				if (!isset($_REQUEST['ACTIVIDAD_BLOQUE'])) {
					...
					new Mensaje($respuesta, 'ACTIVIDAD2_Controller.php');
				}
		...
		case $strings['Borrar']: //Borrado de actividades
			if (!isset($_REQUEST['ACTIVIDAD_ID'])) {
				...
				if (!tienePermisos('Actividad_Delete')) {
					...
					new Actividad_Delete($valores, 'ACTIVIDAD2_Controller.php');
				}
			} else {
		...
		case $strings['Modificar']: //Modificación de actividades
			...
			if (!isset($_REQUEST['ACTIVIDAD_ID'])) {
				...
				if (!tienePermisos('ACTIVIDAD_Edit')) {
					...
					new Actividad_Edit($valores, 'ACTIVIDAD2_Controller.php');
				}
			} else {
		...
		case $strings['Consultar']: //Consulta de actividades
			if (!isset($_REQUEST['ACTIVIDAD_NOMBRE'])) {
				...
				if (!tienePermisos('ACTIVIDAD_Show')) {
					...
					new Actividad_default($datos, 'ACTIVIDAD2_Controller.php');
				}
			}
			break;
		case $strings['CONSULTAR BORRADO']: //Consulta de actividades ocultas
			...
			if (!tienePermisos('Actividad_default_borradas')) {
				...
				//var_dump($datos);
				new Actividad_default_borradas($datos, 'ACTIVIDAD2_Controller.php');
			}
			break;
		default:
