...
Switch ($_REQUEST['accion']) {
    ...
    case $strings['Clientes']:
        if (empty($_POST["email"])) {
            if (!tienePermisos('NOTIFICACION_CLIENTE_Select')) {
                ...
                new NOTIFICACION_CLIENTE_Select($datos, '../Controllers/NOTIFICACION_Controller.php');
            }
        } else {
            $notificacion = get_data_form();
            new NOTIFICACION_EMAIL($notificacion, '../Controllers/NOTIFICACION_Controller.php?accion=Siguiente');
        }
        break;
    ...
    case $strings['Actividad']: //Modificación de páginas
        if (empty($_POST['email'])) {
            if (empty($_POST["actividad"])) {
                ...
                new NOTIFICACION_CLIENTE_ACTIVIDAD_Show($datos, '../Controllers/NOTIFICACION_Controller.php?accion=Actividad');
            }
        }else {
            $notificacion = get_data_form();
