...
//Recoge la información procedente del formulario
    ...
    if (isset($_REQUEST['PAGO_ID'])) {
        ...
        $pago = new PAGO_MODEL($PAGO_ID,  $CLIENTE_ID, '', $PAGO_CONCEPTO, $PAGO_METODO, $PAGO_IMPORTE, $PAGO_ESTADO, ''); //DEFINIR NUEVO CONSTRUCTOR ???
    } else {
        $pago = new PAGO_MODEL('', $CLIENTE_ID, '', $PAGO_CONCEPTO, $PAGO_METODO, $PAGO_IMPORTE, $PAGO_ESTADO, ''); //DEFINIR NUEVO CONSTRUCTOR ???
    }
