		...
		if($result->num_rows == 1){
				return 'La actividad ya existe en la base de datos'; 	
					...
					if ($result->num_rows == 0){
                        ...
                        for($i=0;$i<count($this->ACTIVIDAD_LUGAR);$i++){
                            $sql="INSERT INTO ACTIVIDAD_ALBERGA_LUGAR (ACTIVIDAD_ID, LUGAR_ID) VALUES ('".$ID['ACTIVIDAD_ID']."','".ConsultarIDLugar($this->ACTIVIDAD_LUGAR[$i])."')";
