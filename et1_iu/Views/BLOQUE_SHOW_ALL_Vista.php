						...
						<table  id="btable"  class="responstable" border = 1>
							...
							foreach ($this->datos [$j] as $clave => $valor) {
                                for ($i = 0; $i < count($lista); $i++) {
                                    ...
                                    echo "<td>";
										if($clave==='BLOQUE_LUGAR'){
											echo consultarNomLugar($valor);
										} else
							...
							<td>
								...
								<td>
									<a target="_blank" href='BLOQUE_Controller.php?BLOQUE_ID=<?php echo $this->datos[$j]['BLOQUE_ID'] . '&accion='.$strings['ActEv']; ?>'><?php echo $strings['ActEv'] ?></a>
								</td>
