        ...
        <p>
            <h2>
                ...
                <div>
                    ...
                    $lista = array('EVENTO_NOMBRE','EVENTO_DESCRIPCION');
                    ...
                    <div id="wrapper">
                        ...
                        <table id="btable" border = 1>
                            ...
                            for ($j=0;$j<count($this->datos);$j++){
                                ...
                                ?>
                                <td>
                                    <a href='EVENTO_Controller.php?EVENTO_ID=<?php echo $this->datos[$j]['EVENTO_ID'] . '&accion='.$strings['Invitados']; ?>'> <?php echo $strings['Invitados'] ?></a>
                                </td>
                                <td>
